...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: ogForPath(locale, `/projects/${slug}`, { title, description }),
  };
}
...
async function ProjectHeroVisual({
  name,
  hero,
}: {
  name: string;
...
async function ProjectLinks({ project }: { project: PersonalProject }) {
  const t = await getTranslations("projects");
  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      {project.links.github && (
        ...
        >
          {project.links.repo ? t("githubWeb") : t("github")}
        </a>
      )}
      {project.links.repo && (
        <a
    ...
    <div className="px-6 py-20 content-width-wide">
      <div className="content-width">
        ...
        <div className="flex flex-col gap-16">
          ...
          <section>
            <span className="section-label">{t("highlights")}</span>
          ...
          <section>
            <span className="section-label">{t("features")}</span>
          ...
          <section>
            <span className="section-label">{t("technical")}</span>
